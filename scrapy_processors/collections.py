...
from typing import Union, Callable, Type, Tuple, Any, Iterable, List, Optional, Mapping
...
class MapCompose(ProcessorCollection):
    ...
    processors, or collections of processors to an existing MapCompose instance.
    The result is a new MapCompose instance containing the processors and 
    default_loader_contexts of both original objects.

    Args:
        processors: Any number of callable objects or classes.
...
class Compose(ProcessorCollection):
    ...
    Args:
        processors: Callable objects to be applied to the input.
